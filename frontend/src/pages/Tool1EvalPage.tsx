...
export default function Tool1EvalPage() {
    ...
    useEffect(() => {
        ...
        if (!session) {
            ...
            sessionManager.updatePhase('tool1-eval');
        }

        // Restore saved evaluation responses
        const savedEvalData = sessionManager.getPhaseData('tool1-eval');
    ...
    useEffect(() => {
        if (Object.keys(likertResponses).length > 0) {
            ...
            sessionManager.savePhaseData('tool1-eval', { 
                likertResponses, 
                textResponses,
                allResponses 
            });
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="min-h-screen flex items-start justify-center px-4 pt-16 pb-8 ml-56">
                <div className="max-w-6xl w-full space-y-6">
                    ...
                    <PageNavigation 
                        onBack={() => navigate('/tool1')}
                        backLabel="Back to Tool A Task"
