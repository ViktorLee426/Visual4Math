...
export default function Tool3EvalPage() {
    ...
    const handleNext = () => {
        ...
        sessionManager.savePhaseData('tool3-eval', { responses });
        sessionManager.updatePhase('final-comparison');
        navigate('/final-comparison');
    };
            ...
            <div className="min-h-screen flex items-center justify-center px-8 pt-24 pb-8">
                <div className="max-w-3xl w-full space-y-6">
                    <h1 className="text-2xl font-semibold text-gray-900 text-center">
                        Evaluation: Tool 3 (Free Manipulation Interface)
                    </h1>
                    ...
                    <PageNavigation 
                        ...
                        backLabel="Back to Tool 3 Task"
                        onNext={handleNext}
                        nextLabel="Continue to Final Comparison"
                        showBack={true}
                        showNext={true}
                    />
